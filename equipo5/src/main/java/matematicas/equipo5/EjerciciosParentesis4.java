...
public class EjerciciosParentesis4 extends ActionBarActivity {

    String Pregunta = "+4-9", Pregunta2 = "4-9";
    EditText Respuesta;
    TextView txtVidas;
    Button Resultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicios_parentesis4);
        ...
        Resultado.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Pregunta.equals(Respuesta.getText().toString().replace(" ", "")) || Pregunta2.equals(Respuesta.getText().toString().replace(" ", ""))) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.ejercicios_parentesis4, menu);
        return true;
    }

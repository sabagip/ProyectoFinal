...
public class EjerciciosParentesis11 extends ActionBarActivity {

    String Pregunta = "+13-24+68+48-95", Pregunta2 = "13-24+68+48-95";
    EditText Respuesta;
    TextView txtVidas;
    Button Resultado;
        ...
        Resultado.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Pregunta.equals(Respuesta.getText().toString().replace(" ", "")) ||
                    Pregunta2.equals(Respuesta.getText().toString().replace(" ", ""))) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.ejercicios_parentesis11, menu);
        return true;
    }

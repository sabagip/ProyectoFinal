...
public class EjerciciosSignos extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicios_signos);
    ...
    public void guardarMemoriaInterna(){
        ...
        //editor.putBoolean("completadoUsoSignos", true);

        editor.commit();

        try {
            String avanceSignos = 1 + "";

            FileOutputStream fileOutputStream = openFileOutput("Avances", Context.MODE_PRIVATE);

            fileOutputStream.write(avanceSignos.getBytes());
            editor.commit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.ejercicios_signos, menu);
        return true;
    }

...
public class EjerciciosParentesis5 extends ActionBarActivity {

    String Pregunta = "-5+6+4-9";
    EditText Respuesta;
    TextView txtVidas;
    Button Resultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicios_parentesis5);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.ejercicios_parentesis5, menu);
        return true;
    }
